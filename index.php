<!doctype html>
    ...
    <head>
        <meta charset="utf-8">
        <title>Fair play in de Vollyball Top League</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <main>
                ...
                <div class="row">
                    <div class="box half">
                        ...
                        <p class="number"><?php echo 380 ?></p>
                    </div>
                    <div class="box half">
                        <h2>Gemiddeld per wedstrijd:</h2>
                        <p class="number"><?php echo 7 ?></p>
                    </div>
                </div>
                <div class="row">
                    <div class="box">
                        ...
                        <pre>
                            <?php 
                            echo file_get_contents('python/zwartboek.txt');
                            ?>
                        </pre>
                    </div>
                </div>
                <div class="row">
                    <div class="box">
                        <h2>Wedstrijden met minder dan 2 overtredingen (laatste 21 dagen):</h2>
                        <pre>
                            <?php 
                            echo file_get_contents('python/eregalerij.txt');
                            ?>
                        </pre>
                    </div>
                </div>
            ...
            <footer>
                ...
                <p>&copy; Team X, Mootje, Nino en Arne</p>
            </footer>
